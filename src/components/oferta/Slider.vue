<template>
    <div class="section oferta-slider" id="realizacje">
        <ClientOnly>
            <carousel id="ofertaSlider" v-on:pageChange="pageChange"  :perPage="1" class="slider-oferta" :navigationEnabled="true" :paginationEnabled="false" :perPageCustom="[[768, 1], [1024, 1]]">
                <slide v-for="slide in $static.allPages.edges[0].node.oferta.slider" :key="slide.id">
                    <div class="slider-oferta__content" >
                        <div class="slider-oferta-content">
                            <CategoryHeader :text="slide.title" :customClass="'slider-oferta-content__category'"></CategoryHeader>
                    ...
                    <div class="slider-indicator">
                        ...
                        <div class="slider-indicator__text">0{{currentSlide}} <span>/</span><span> _0{{$static.allPages.edges[0].node.oferta.slider.length}}</span></div>
                    </div>
                </slide>
            </carousel>
        </ClientOnly>
