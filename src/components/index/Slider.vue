...
<ClientOnly>
      ...
      >
        ...
        <slide v-for="slide in $static.allPages.edges[0].node.index.mainSlider.slides" :key="slide.id">
            <g-image v-in-viewport :src="require('!!assets-loader!~/assets/img/' + slide.image)" />
            <div class="slide-content">
                <CategoryHeader :text="slide.category" :customClass="'slide-content__category'"></CategoryHeader>
            ...
            <div class="slider-indicator">
              ...
              <div class="slider-indicator__text">0{{currentSlide}} <span>/</span><span> _0{{$static.allPages.edges[0].node.index.mainSlider.slides.length}}</span></div>
            </div>
        </slide>
      </carousel>
