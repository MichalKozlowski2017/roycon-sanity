<template>
    <div class="section Realizacje" id="realizacje" v-in-viewport>
        ...
        <CategoryHeader v-in-viewport :text="'NASZE REALIZACJE'" :customClass="'Realizacje__category'"></CategoryHeader>
        <ClientOnly>
            <carousel id="sliderRealizacje" :perPage="1" class="slider-realizacje" :navigationEnabled="true" :paginationEnabled="true" :perPageCustom="[[768, 1], [1024, 1]]">
                <slide v-for="slide in $static.allPages.edges[0].node.realizacje" :key="slide.id">
                    <div class="slider-realizacje__content" >
                           <g-image v-in-viewport :src="require('!!assets-loader!~/assets/img/' + slide.image)" :alt="slide.alt"/>
                    </div>
                </slide>
            </carousel>
        </ClientOnly>
